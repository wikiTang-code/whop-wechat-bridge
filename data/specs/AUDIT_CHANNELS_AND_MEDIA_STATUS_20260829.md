...
|:---|:---|:---|:---|:---|:---|
| **【讨论区股票记录】** | 81 个 | **56 张** | **69.1%** | 1,571.0 KB | 消息量适中，已成功落盘大量高清持仓图 |
| **【早期历史交流区】** | 15 个 | **1 张** | **6.7%** | 2.6 KB | 早期部分图片已落盘 |
| **【不用翻墙美股发布】** | 234 个 | **0 张** | **0.0%** | 0.0 KB | 前端需分块挂载历史月份以触发批量换签 |
| **【历史股票期权记录区】** | 189 个 | **0 张** | **0.0%** | 0.0 KB | 需分块挂载历史月份以触发批量换签 |
| **【不用翻墙美股讨论区】** | 1,037 个 | **0 张** | **0.0%** | 0.0 KB | 优先级排在最后 |
| **全库去重总计** | **1,591 个** | **85 张 (实存文件)** | **5.3%** | **2,396.4 KB** | 抽检文件 `size > 0` 且生成有效 SHA256 |
