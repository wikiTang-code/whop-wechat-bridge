...
| P2-15 | 软降级钩子（R5） | 🚧 G0 开轨 | 拆分 [`docs/p2-15-task-split-parallel.md`](./p2-15-task-split-parallel.md)；缺口 [`docs/p2-15-soft-degrade-gap-checklist.md`](./p2-15-soft-degrade-gap-checklist.md) |
