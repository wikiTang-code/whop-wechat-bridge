...
| CHG-018 | `done`（代码）/ **残留 DEBT-014** | **统一 WSL2 AI 运行时**：Step 1–3 Supervisor+Arbiter+单测绿已交付；**真实 llama-server 挂载与关 LMS 切流未验收**（见 04 DEBT-014 / Q-007 reopened） | 2026-09-19 `agent:gemini` 落地 · `agent:cursor` 抽审 |
