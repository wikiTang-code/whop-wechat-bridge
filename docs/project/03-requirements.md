...
| CHG-018 | `done` | **统一 WSL2 AI 运行时架构升级**：消灭 Windows LM Studio 7G 物理内存常驻，WSL 内 14B↔1.5B 飞轮时分复用；保留 `:8080`；Step 1–3 受管守护与 Arbiter 闭环，门禁全绿，Q-007 获得 Human 批准切流完成 | 2026-09-19 提案 `agent:gemini` · 审阅/抽审 `agent:cursor` · `wsl-unified-ai-runtime-plan.md` |
