...
| REQ-037 | P2 | L3 | `accepted` | **大V全频道多模态图文对齐与交易知识本体图谱**（P1 Done；**P2 骨架 Done**：`semantic_cu`+heuristic+cu-sample+golden-smoke；**P2 验收**≥30 黄金集待开；P3 未开；P4 冻结） | Owner=`agent:cursor`；下一切片在共享候选池；Q-006 不影响 P2 |
