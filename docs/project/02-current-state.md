...
|----|-----|
| 分支 | `main` |
| HEAD / vs origin | 以 `git log -1` / `git status -sb` 为准；REQ-058 Appendix A 5m N=196 主校准门禁 passed、Appendix B 1m 诊断 `n_scored=33` 非主表、`done-strat` 未过；CHG-052 新行 `t_arrive` 不回填历史（#16=`e54ffd70`） |
