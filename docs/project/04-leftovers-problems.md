...
| DEBT-026 | **RTH 赵哥点位未进 GCP `trade_signals`（CHG-060 代码已交）**：persist 硬锁+正则已落地。GCP 仍 91 条/最新 9/18 直到 HITL restart。刀 2 仅 `zhao_follow`∧FILLED。烟测禁止冒充跟单 | CHG-060 · `zhao_print_persist.js` | **P1 待 GCP ingest** |
