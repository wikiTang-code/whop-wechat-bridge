...
| DEBT-025 | **CHG-056 1s hot 未上 GCP**（不挡 Cloud done-eng）：采集器与夹具已入库。无 live 推送、无 systemd、rclone 未装、`cold_path=null`。合并后由 **Gemini 部署**。禁止 Yahoo 插值 1s、禁止十档、禁止 80 标的池、禁止把空洞秒填成假历史 | `collect_1s_ohlcv.js` · `chg056-market-1s-ohlcv.md` | **P2 部署** |
