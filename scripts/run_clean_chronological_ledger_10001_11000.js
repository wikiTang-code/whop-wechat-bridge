...
console.log('========================================================================================');
console.log('📖 启动 10001~11000 消息段时序动态账本流水线：6月中旬至7月下旬实战');
console.log('========================================================================================\n');

// 1. 读取 10001 ~ 11000 条赵哥时序消息 (LIMIT 1000 OFFSET 10000)
...
console.log(`👤 载入 10001~11000 条消息 (起始: ${new Date(zhaoMessages[0].created_at).toISOString().slice(0, 10)} -> 结束: ${new Date(zhaoMessages[zhaoMessages.length - 1].created_at).toISOString().slice(0, 10)})\n`);
...
const resultData = {
  metadata: {
    segment: '10001~11000 消息段 (2026-06-04 ~ 2026-07-22)',
