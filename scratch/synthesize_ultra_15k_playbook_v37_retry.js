...
console.log('====================================================');
console.log('🏛️ Gemini 3.7 终极机构级【1.5 万字超深度大V操盘白皮书】合成');
console.log('====================================================\n');
...
console.log('⏳ 为确保彻底避让 429 免费层滑动窗口，先静息等待 55 秒，随后一击即中全量吐字...');
await new Promise(r => setTimeout(r, 55000));

let playbookContent = null;
for (let i = 0; i < keys.length; i++) {
  console.log(`⏳ 正在使用 Key #${i + 1} 合成 1.5 万字终极深度白皮书...`);
  try {
    ...
    console.warn(`⚠️ Key #${i + 1} 报错:`, err.message);
  }
}
